...
class __TwigTemplate_2c3771a347b09491027030acb04b87969f5bd222def7841f4175f910668bbb61 extends Twig_Template
{
    ...
    <table class=\"dataTable\" cellspacing=\"0\">
        ...
        echo "</td>
            <td class=\"column\">";
        // line 19
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('number')->getCallable(), array((isset($context["visitorsCountToday"]) ? $context["visitorsCountToday"] : $this->getContext($context, "visitorsCountToday")))), "html", null, true);
        echo "</td>
            <td class=\"column\">";
        // line 20
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('number')->getCallable(), array((isset($context["pisToday"]) ? $context["pisToday"] : $this->getContext($context, "pisToday")))), "html", null, true);
        echo "</td>
        </tr>
        <tr class=\"\">
            <td class=\"label column\">";
        ...
        echo "</td>
            <td class=\"column\">";
        // line 24
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('number')->getCallable(), array((isset($context["visitorsCountHalfHour"]) ? $context["visitorsCountHalfHour"] : $this->getContext($context, "visitorsCountHalfHour")))), "html", null, true);
        echo "</td>
            <td class=\"column\">";
        // line 25
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('number')->getCallable(), array((isset($context["pisHalfhour"]) ? $context["pisHalfhour"] : $this->getContext($context, "pisHalfhour")))), "html", null, true);
        echo "</td>
        </tr>
        </tbody>
    </table>
...
", "@Live/_totalVisitors.twig", "C:\\wamp64\\www\\Mendoza\\piwik\\piwik\\plugins\\Live\\templates\\_totalVisitors.twig");
    }
}

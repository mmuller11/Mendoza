...
class __TwigTemplate_c6b2e1a46ddf21f2b14f4f31b2ca2c759640d40175a637531f27a03c060e0f41 extends Twig_Template
{
    ...
    ";
        ...
        if ((isset($context["isSuperUser"]) ? $context["isSuperUser"] : $this->getContext($context, "isSuperUser"))) {
            ...
            ";
            // line 24
            if ((isset($context["hasDiagnostics"]) ? $context["hasDiagnostics"] : $this->getContext($context, "hasDiagnostics"))) {
                // line 25
...
(isset($context["isFeedbackEnabled"]) ? $context["isFeedbackEnabled"] : $this->getContext($context, "isFeedbackEnabled"))) {
            // line 36
            echo "        ";
            echo (isset($context["feedbackHelp"]) ? $context["feedbackHelp"] : $this->getContext($context, "feedbackHelp"));
            echo "
    ...
    ";
        // line 39
        if ((((isset($context["hasPremiumFeatures"]) ? $context["hasPremiumFeatures"] : $this->getContext($context, "hasPremiumFeatures")) && (isset($context["isMarketplaceEnabled"]) ? $context["isMarketplaceEnabled"] : $this->getContext($context, "isMarketplaceEnabled"))) && (isset($context["isInternetEnabled"]) ? $context["isInternetEnabled"] : $this->getContext($context, "isInternetEnabled")))) {
            // line 40
    ...
    ";
        ...
        // line 42
        echo "    ";
        if ((((isset($context["hasNewPlugins"]) ? $context["hasNewPlugins"] : $this->getContext($context, "hasNewPlugins")) && (isset($context["isMarketplaceEnabled"]) ? $context["isMarketplaceEnabled"] : $this->getContext($context, "isMarketplaceEnabled"))) && (isset($context["isInternetEnabled"]) ? $context["isInternetEnabled"] : $this->getContext($context, "isInternetEnabled")))) {
            // line 43
    ...
    ";
        ...
        if (((isset($context["hasDonateForm"]) ? $context["hasDonateForm"] : $this->getContext($context, "hasDonateForm")) || (isset($context["hasPiwikBlog"]) ? $context["hasPiwikBlog"] : $this->getContext($context, "hasPiwikBlog")))) {
            ...
            // line 66
            echo "            ";
            if (((isset($context["hasPiwikBlog"]) ? $context["hasPiwikBlog"] : $this->getContext($context, "hasPiwikBlog")) && (isset($context["isInternetEnabled"]) ? $context["isInternetEnabled"] : $this->getContext($context, "isInternetEnabled")))) {
                // line 67
                echo "                <div class=\"col s12 ";
                if ((isset($context["hasDonateForm"]) ? $context["hasDonateForm"] : $this->getContext($context, "hasDonateForm"))) {
                    echo "m6";
...
{% endblock %}
", "@CoreAdminHome/home.twig", "C:\\wamp64\\www\\Mendoza\\piwik\\piwik\\plugins\\CoreAdminHome\\templates\\home.twig");
    }
}

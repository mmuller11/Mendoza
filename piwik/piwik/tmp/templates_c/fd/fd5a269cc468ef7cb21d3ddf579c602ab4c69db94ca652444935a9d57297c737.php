...
/* admin.twig */
class __TwigTemplate_2696f678e194486db16dc8cc39509ea000889337e935ca566f728d1f269bcdb6 extends Twig_Template
{
...
";
    ...
    ";
        // line 31
        echo call_user_func_array($this->env->getFunction('postEvent')->getCallable(), array("Template.beforeContent", "admin", (isset($context["currentModule"]) ? $context["currentModule"] : $this->getContext($context, "currentModule")), (isset($context["currentAction"]) ? $context["currentAction"] : $this->getContext($context, "currentAction"))));
        echo "
...
{% endblock %}
", "admin.twig", "C:\\wamp64\\www\\Mendoza\\piwik\\piwik\\plugins\\Morpheus\\templates\\admin.twig");
    }
}
